				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item">
								<a href="../siswa/jadwal.php" class="nav-link" role="button" aria-haspopup="true" aria-expanded="false">Jadwal</a>
							</li>
							<li class="nav-item">
								<a href="../siswa/materi.php" class="nav-link" role="button" aria-haspopup="true" aria-expanded="false">Materi</a>
							</li>
							<li class="nav-item">
								<a href="../siswa/nilai.php" class="nav-link" role="button" aria-haspopup="true" aria-expanded="false">Nilai</a>
							</li>
							<li class="nav-item">
							...
							<li class="nav-item submenu dropdown">
								<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">SISWA</a>
