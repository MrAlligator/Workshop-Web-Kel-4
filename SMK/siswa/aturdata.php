...
<body>
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item"><a class="nav-link" href="nilai.php">Nilai</a></li>
							...
							<li class="nav-item submenu dropdown">
								<a href="#" class="nav-link dropdownwn-toggle" data-toggle="dropdown" role="button" aria-hashpopup="true"
	...
	<style>
	 .banner_area4 {
                                position: relative;
                                background: url(../siswa/img/siswa.png) no-repeat center center;
                                z-index: 1;
                                min-height: 392px;
