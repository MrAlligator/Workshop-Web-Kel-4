					...
					<div class="progress-table">
						...
						?>
							...
							<div class="table-row">
								...
								<div class="country">
									<a href="edit.php?id=<?php echo $d['id_nilai']; ?>"><button class="btn btn-warning">Edit</button></a>
									<a href="hapusnilai.php?id=<?php echo $d['id_nilai']; ?>"><button class="btn btn-danger">Hapus</button></a>
								</div>
							</div>
						<?php
						}
