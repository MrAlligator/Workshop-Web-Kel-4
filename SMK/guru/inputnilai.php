				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item">
								<a href="siswa2.php" class="nav-link" role="button" aria-haspopup="true" aria-expanded="false">Daftar Siswa</a>
							</li>
							<li class="nav-item">
								<a href="nilaisiswa.php" class="nav-link" role="button" aria-haspopup="true" aria-expanded="false">Nilai Siswa</a>
							</li>
							<li class="nav-item">
								<a href="uploadmateri.php" class="nav-link" role="button" aria-haspopup="true" aria-expanded="false">Upload Materi</a>
							</li>
							<li class="nav-item">
						...
						<form class="form-group" action="simpannilai.php" method="post">
							<table>
								...
								<tr>
									...
									<td><input type="number" name="uh" placeholder="Nilai Ulangan Harian" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nilai Ulangan Harian'" required class="single-input"></td>
								</tr>
								<tr>
									<td>Nilai UTS</td>
									<td><input type="number" name="uts" placeholder="Nilai UTS" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nilai UTS'" required class="single-input"></td>
								</tr>
								<tr>
									<td>Nilai UAS</td>
									<td><input type="number" name="uas" placeholder="Nilai UAS" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nilai UAS'" required class="single-input"></td>
								</tr>
								<tr>
									<td>Nilai Sikap</td>
									<td><input type="number" name="sikap" placeholder="Nilai sikap" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nilai Sikap'" required class="single-input"></td>
								</tr>
								<tr>
