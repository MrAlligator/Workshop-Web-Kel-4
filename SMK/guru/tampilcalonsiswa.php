				...
				<div class="progress-table-wrap">
					<div class="progress-table">
						...
						<?php 
							include 'koneksi.php';
							$no = 1;
							$data = mysqli_query($koneksi,"select * from tb_calon_siswa");
							while($d = mysqli_fetch_array($data)){
						?>
						<div class="table-row">
							<div class="serial"><?php echo $no++; ?></div>
							<div class="country"><?php echo $d['no_daftar']; ?></div>
							<div class="visit"><?php echo $d['nama_lengkap']; ?></div>
							<div class="country"><?php echo $d['tmptlahir']; ?></div>
							<div class="visit"><?php echo $d['tgllahir']; ?></div>
							<div class="country"><?php echo $d['jk']; ?></div>
							<div class="country"><?php echo $d['agama']; ?></div>
							<div class="country"><a  href="info.php?id_daftar=<?php echo $d['id_daftar']; ?>">Info Detail</a></div>
