...
if ($status2== 'admin'){
    ...
    echo "<script>alert('Data Berhasil di Ubah');document.location.href='../admin/karyawan2.php'</script>";echo "<script>alert('Data Berhasil di Ubah');document.location.href='../admin/karyawan2.php'</script>";
}else{
    mysqli_query($koneksi,"update tb_guru set nip='$nip',nama_guru='$nama',jk_guru='$jk',tmptlahir='$tmptlahir',tgllahir='$tgllahir',agama_guru='$agama',alamat_guru='$alamat',telp_guru='$telp',status='$status',password='$pass' where nip ='$id'");
    echo "<script>alert('Data Berhasil di Ubah');document.location.href='../admin/karyawan2.php'</script>";
    }
