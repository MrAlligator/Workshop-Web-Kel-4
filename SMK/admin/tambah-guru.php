				...
				<div class="row">
					<div class="col-md-6 col-xs-12">
						...
						<form method="post" action="tambah_aksi2.php" enctype="multipart/form-data">
							...
							<input type="text" name="tempat" class="form-control" placeholder="Tempat Lahir" maxlength="25" required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')">
